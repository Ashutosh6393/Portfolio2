      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex flex-col items-center">
            <MessageSquare className="h-12 w-12 text-zinc-600 mb-6" />
            
            <h3 className="text-xl font-semibold text-zinc-200 mb-2">Let's Connect</h3>
            <p className="text-zinc-400 mb-6">Drop me a message and let's discuss your project.</p>

            <Button
              asChild
              className="bg-white text-black hover:bg-zinc-200 transition-colors mb-8"
            >
            ...
            <div className="w-full border-t border-zinc-800 pt-6">
              <p className="text-sm text-zinc-500 mb-4">Or find me on</p>
              <div className="flex justify-center gap-4">
                <a
                  href="https://github.com/Ashutosh6393"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-800/50 border border-zinc-700/50 text-zinc-400 hover:text-white hover:border-zinc-600 transition-all"
                >
