    ...
    <section className="py-20 px-6 bg-zinc-900/30">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">What I'm Currently Doing</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {activities.map((activity, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group p-5 rounded-xl bg-zinc-800/30 border border-zinc-800 hover:border-zinc-700 transition-all duration-300 hover:bg-zinc-800/50"
            >
              <div className="flex items-start gap-4">
                <div className="p-2 rounded-lg bg-zinc-700/30 text-zinc-300 group-hover:text-white transition-colors">
                  <activity.icon className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="font-semibold text-zinc-200 mb-1">{activity.title}</h3>
